...
class KnapsackASPSolver():
    ...
    def retrieve_solutions(self, list_symbols: List[List[Symbol]]) -> ResultStorage:
        ...
        for symbols in list_symbols:
            ...
            list_taken = [1 if i in in_list else 0 for i in range(1,self.knapsack_model.nb_items+1)]
            solution = KnapsackSolution(problem=self.knapsack_model, list_taken=list_taken)
